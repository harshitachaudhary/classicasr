...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from tblgallery_video", con);
    ...
    protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
       ...
       // string username = gvDetails.DataKeys[e.RowIndex].Values["UserName"].ToString();
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("proc_tblgallery_video", con);
    ...
    protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            cmd.Parameters.AddWithValue("@heading", txtUsrname.Text);
