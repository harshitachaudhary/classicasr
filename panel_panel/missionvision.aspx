<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="missionvision.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
               ...
               <div class="span12">
                  ...
                  Mission&Vision
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">  Mission&Vision</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
                 ...
                 <form action="#" class="form-horizontal" id="fhgfh" runat="server">
                           ...
                           <div class="about-us">
                                     ...
                                     <div class="control-group">
                                       <label class="control-label">Mission :
                                       ...
                                       <div class="controls">
                                             <cc1:Editor ID="txtmission" runat="server" Height="150px" Width="400px" />
                                ...
                                <div class="row-fluid">
                                     <div class="control-group">
                                       <label class="control-label">Vision:
                                           <%--<asp:RequiredFieldValidator ID="RequireddFieldValidator5" runat="server" ControlToValidate="Editor1" ValidationGroup="tt" ErrorMessage="Pls. Enter Description. !" Text="*" ForeColor="#cc3300"></asp:RequiredFieldValidator>--%>
                                       </label>
                                       <div class="controls">
                                             <cc1:Editor ID="txtvision" runat="server" Height="150px" Width="400px" />                                           
                                       </div>
                                       </div>
                                   </div>
