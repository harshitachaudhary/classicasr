...
public partial class nyksi_panel_Upload_Main_Product : System.Web.UI.Page
{
    ...
    protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
       ...
       // string username = gvDetails.DataKeys[e.RowIndex].Values["UserName"].ToString();
        ...
        TextBox txtlocation = (TextBox)gvDetails.Rows[e.RowIndex].FindControl("txteditlocation");
        TextBox txtdiscription = (TextBox)gvDetails.Rows[e.RowIndex].FindControl("txtdiscription");
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("prco_tbltesti", con);
    ...
    protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            TextBox txtlocation = (TextBox)gvDetails.FooterRow.FindControl("txtftlocation");
            TextBox txtdicription = (TextBox)gvDetails.FooterRow.FindControl("txtftrdiscription");
            ...
            cmd.Parameters.AddWithValue("@location", txtlocation.Text);
            cmd.Parameters.AddWithValue("@discription", txtdicription.Text);
            cmd.Parameters.AddWithValue("@img",strfile1);
