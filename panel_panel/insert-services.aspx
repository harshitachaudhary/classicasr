<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="insert-services.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title"> Insert Services
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">Insert Service </a><span class="divider-last">&nbsp;</span></li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="about-us">
                            ...
                            <div class="row-fluid">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <cc1:Editor ID="Editorservccontent" runat="server" Height="400px" Width="600px" />
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    <label class="control-label">Image1 
                                       <span style="color: red">(Image Size:- Width:370px & Height:250px)</span></label>
                                    <div class="controls">
                                 ...
                                 <div class="control-group">
                                    <label class="control-label">Image2
                                       <span style="color: red">(Image Size:- Width:370px & Height:250px)</span></label>
                                    <div class="controls">
                                 ...
                                 <div class="control-group">
                                    <label class="control-label">Image3 
                                       <span style="color: red">(Image Size:- Width:370px & Height:250px)</span></label>
                                    <div class="controls">
                                 ...
                                 <div class="control-group">
                                    <label class="control-label">Image4 
                                       <span style="color: red">(Image Size:- Width:370px & Height:250px)</span></label>
                                    <div class="controls">
                            ...
                            <div class="form-actions clearfix">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:Button ID="Button1" runat="server" Text="Insert" CssClass="btn btn-success" ValidationGroup="tt" OnClick="Button1x_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
