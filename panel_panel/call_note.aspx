<%@ Page Title="" Language="C#" MasterPageFile="~/panel_panel/admin_master.master" AutoEventWireup="true" CodeFile="call_note.aspx.cs" Inherits="nyksi_panel_Upload_Main_Product" %>
               ...
               <div class="span12">
                  ...
                  NOTE
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Note</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                 ...
                 <form action="#" class="form-horizontal" id="fhgfh" runat="server">
                           ...
                           <div class="about-us">
                               ...
                               <div class="row-fluid">
                                     <div class="control-group">
                                       <label class="control-label">Heading2:
                                           <%--<asp:RequiredFieldValidator ID="RequireddFieldValidator5" runat="server" ControlToValidate="Editor1" ValidationGroup="tt" ErrorMessage="Pls. Enter Description. !" Text="*" ForeColor="#cc3300"></asp:RequiredFieldValidator>--%>
                                       </label>
                                       <div class="controls">
                                           <asp:TextBox ID="txtheading2" runat="server" Width="80%"></asp:TextBox>
                                           <%-- <cc1:Editor ID="txtheading2" runat="server" Height="150px" Width="400px" />--%>
                                       </div>
                                       </div>
                                   </div>
                                  ...
                                  <div class="row-fluid">
                                     <div class="control-group">
                                       ...
                                       <div class="controls">
                                           <asp:TextBox ID="txtnumber" runat="server" Width="80%"></asp:TextBox>
                                           <%-- <cc1:Editor ID="txtnumber" runat="server" Height="150px" Width="400px" />--%>
                                       </div>
                                       </div>
                                   </div>
